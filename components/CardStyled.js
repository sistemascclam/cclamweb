...
export default function CardStyled({title,left,right,col}) {
    return (
        <div className="py-6 flex flex-col justify-center my-10">
            <div className={`relative ${col?'py-4':'pt-12'}`}>
                <div className="absolute inset-1 bg-gray-200 shadow-lg transform -skew-y-6 lg:skew-y-0 md:skew-y-0 md:-rotate-1 lg:-rotate-1 rounded-3xl"></div>
                <div className="absolute inset-1 bg-themeLightBlue  shadow-lg transform -skew-y-6 lg:skew-y-0 md:skew-y-0 md:-rotate-2 lg:-rotate-2 rounded-3xl"></div>
