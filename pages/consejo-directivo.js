            ...
            <section className="pt-32 lg:pt-28 pb-4">
                ...
                >
                    <div className="text-center mb-8">
                        <h1 className="text-3xl lg:text-5xl md:text-5xl sm:text-6xl font-black">Consejo Directivo - Gerencia General <span className="block text-bgblue mt-2">2019 - 2022</span></h1>
                    </div>
                </Transition>
                <Transition
                    show={true}
