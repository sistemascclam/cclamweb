                    ...
                    <div className="relative rounded-b-xl bg-white">
                        <div className="p-6">
                            ...
                            <div className="absolute -top-10 bg-gray-100 right-6 rounded-xl w-20 shadow-md">
                                <div className="bg-blue-600 rounded-t-xl text-base px-2 font-normal text-center text-white">JUN</div>
                                <p className="text-center text-4xl py-1">17</p>
                            </div>
                        ...
                        <a className="bg-blue-600 w-full flex justify-center py-1 rounded-lg text-white text-base mt-10 hover:bg-blue-700" href={`https://api.whatsapp.com/send/?phone=51942418670&text=${`Confirmo mi asistencia al evento del ${moment(actividadObject?.fechaInicio).format("D [de] MMMM")}`}&app_absent=0`} target="_blank" rel="noreferrer">Confirmar asistencia</a>
