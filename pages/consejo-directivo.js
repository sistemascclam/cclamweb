    ...
    return (
        <Layout>
            ...
            <section className="pb-4 mx-auto">
                <div className="mb-8 bg-directivos bg-center h-96 bg-cover relative">
                    <div className='absolute bg-black bg-opacity-70 inset-0'>
                        <div className='relative flex items-end h-full p-10'>
                            ...
                            Consejo Directivo - Gerencia General 2019 - 2022
                            </h1>
                        </div>
                    </div>
                </div>
                <div className="bg-white w-full shadow-close px-5 lg:px-28 pt-10 pb-12 lg:py-20 rounded-4xl">
                    <h3 className="font-extrabold text-bgblue text-xl">GÉNESIS DE UNA CÁMARA IMPULSADORA DEL DESARROLLO DE LAMBAYEQUE</h3>
                    ...
                    <CardStyled
                        ...
                        right={<Image
                            src={`${process.env.STORAGE_URL_FT}${'/images/consejo/directivos/olivio_huancaruna.png'}`}
                    ...
                    />
                    <div className="my-8">
                        <div className="relative mx-8 mb-3"><h3 className="text-bgblue font-black text-lg">CONSEJO DIRECTIVO 2019 – 2022</h3></div>
                        <ConsejoCarousel textLight={false} />
                    </div>
                    <CardStyled
