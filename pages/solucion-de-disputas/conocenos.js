                                ...
                                <div className="w-full lg:w-1/2 mt-20">
                                    ...
                                    <div className="mt-6">
                                        <Link href={`/solucion-de-disputas/centro-de-arbitraje`}>
                                            <a>
                                                <div className="mb-4 mx-auto w-full lg:w-96 bg-themeBlue bg-opacity-0 px-5 py-4 rounded-full text-gray-600 flex transition duration-500 ease-in-out transform hover:-translate-y-2 cursor-pointer">
                                                    <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8 text-themeLightBlue mr-5" viewBox="0 0 20 20" fill="currentColor">
                                        ...
                                        {/* <Link href={`/solucion-de-disputas/junta-resolucion-disputas`}>
                                            <a>
                                                <div className="mx-auto w-full lg:w-96 bg-themeBlue bg-opacity-0 px-5 py-4 rounded-full text-gray-600 flex transition duration-500 ease-in-out transform hover:-translate-y-2 cursor-pointer">
