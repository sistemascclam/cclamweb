...
export default function index() {
    return (
        <>
            ...
            <div className="flex justify-center relative overflow-y my-5 w-full">
                <GoogleAdd slot_id="6611472087" />
            </div>
                <div className="flex flex-wrap justify-between text-gray-600">
                    ...
                    <div className="w-48 mt-10 lg:mt-20">
                        ...
                        <Image src={`${process.env.STORAGE_URL_FT}/svgs/tarjetas.svg`} width="871" height="150" layout="responsive" alt="tarjetasdepagos" />
                    </div>
                    <div className="flex flex-col mt-10 lg:mt-20">
                        ...
                        <div className="flex mt-5">
                            ...
                            <a href="tel:51944680147" target="_blank" rel="noreferrer" className="text-sm">+51 944 680 147</a>
                        </div>
                        <div className="flex mt-5">
                            <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-themeLightBlue mr-3" viewBox="0 0 20 20" fill="currentColor">
                            ...
                            <a href="mailto:secretariagerencia@cclam.org.pe" target="_blank" rel="noreferrer" className="text-sm">secretariagerencia@cclam.org.pe</a>
                        </div>
                        <div className="flex mt-5">
                            <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-themeLightBlue mr-3" viewBox="0 0 20 20" fill="currentColor">
                ...
                <div className="w-full text-center mt-14">
                    ...
                    <div className="flex justify-center mt-2">
                        <a href="https://www.facebook.com/cclambayeque" target="_blank" rel="noreferrer" className="bg-themeLightBlue text-white rounded-full p-2 mr-2">
                        ...
                        <a href="https://twitter.com/cclambayeque" target="_blank" rel="noreferrer" className="bg-themeLightBlue text-white rounded-full p-2 mr-2">
                            <svg viewBox="0 0 24 24" height="20" width="20" focusable="false" role="img" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                <path d="M19.633 7.997c.013.175.013.349.013.523 0 5.325-4.053 11.461-11.46 11.461-2.282 0-4.402-.661-6.186-1.809.324.037.636.05.973.05a8.07 8.07 0 0 0 5.001-1.721 4.036 4.036 0 0 1-3.767-2.793c.249.037.499.062.761.062.361 0 .724-.05 1.061-.137a4.027 4.027 0 0 1-3.23-3.953v-.05c.537.299 1.16.486 1.82.511a4.022 4.022 0 0 1-1.796-3.354c0-.748.199-1.434.548-2.032a11.457 11.457 0 0 0 8.306 4.215c-.062-.3-.1-.611-.1-.923a4.026 4.026 0 0 1 4.028-4.028c1.16 0 2.207.486 2.943 1.272a7.957 7.957 0 0 0 2.556-.973 4.02 4.02 0 0 1-1.771 2.22 8.073 8.073 0 0 0 2.319-.624 8.645 8.645 0 0 1-2.019 2.083z"></path>
                            </svg>
                        </a>
                        <a href="https://www.instagram.com/cclambayeque/" target="_blank" rel="noreferrer" className="bg-themeLightBlue text-white rounded-full p-2 mr-2">
                            <svg viewBox="0 0 24 24" height="20" width="20" focusable="false" role="img" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <a href="https://www.youtube.com/channel/UC1AiwP-g_axxOcyEKtFJh6w/videos" target="_blank" rel="noreferrer" className="bg-themeLightBlue text-white rounded-full p-2 mr-2">
