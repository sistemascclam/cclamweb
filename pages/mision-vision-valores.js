            ...
            <section className="py-24 flex flex-wrap">
                ...
                <div className="w-full px-10 lg:w-1/2 lg:pr-10">
                    ...
                    >
                        <div className="bg-white rounded-xl p-5 shadow-sm mb-4">
                            <div className="flex content-center">
                                <svg className="text-bgblue" viewBox="0 0 24 24" height="40" width="40" focusable="false" role="img" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                    ...
                    >
                        <div className="bg-white rounded-xl p-5 shadow-sm mb-4">
                            <div className="flex content-center">
                                <svg className="text-bgblue" viewBox="0 0 16 16" height="40" width="40" focusable="false" role="img" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                    ...
                    >
                        <div className="bg-white rounded-xl p-5 shadow-sm mb-4">
                            <div className="flex content-center">
                                <svg className="text-bgblue" viewBox="0 0 512 512" height="40" width="40" focusable="false" role="img" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
