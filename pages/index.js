    ...
    return (
        <Layout home>
            ...
            <section id="nuestras-redes" className="text-center mt-4 ">
                ...
                <div className="p-3 md:p-10 mt-4 flex flex-col md:flex-row justify-center gap-10">
                    <div className="overflow-y-auto h-[400px] md:h-[600px] w-full md:w-[400px]">
                        <iframe src="https://www.facebook.com/plugins/page.php?href=https%3A%2F%2Fwww.facebook.com%2Fcclambayeque%2F&tabs=timeline&width=400&height=600&small_header=false&adapt_container_width=true&hide_cover=false&show_facepile=false&appId" width="400" height="600" style={{ border: "none", overflow: "hidden" }} scrolling="no" frameBorder="0" allowFullScreen={true} allow="autoplay; clipboard-write; encrypted-media; picture-in-picture; web-share"></iframe>
                    </div>
                    <div className="overflow-y-auto h-[400px] md:h-[600px] w-full md:w-[400px]">
            ...
            >
                        ...
                        <Link href={`/solucion-de-disputas/centro-de-conciliacion`}>
                            <a>
                                <div className="mb-4 w-full lg:w-96 bg-themeLightBlue bg-opacity-0 px-5 py-2 rounded-full text-gray-600 flex transition duration-500 ease-in-out transform hover:scale-105 cursor-pointer">
                                    ...
                                    <p className="my-auto text-base text-left">Centro de Conciliación Extrajudicial</p>
                                </div>
                            </a>
                        </Link>
                ...
                <div className="w-52 mb-10 lg:mt-0 lg:w-96 mx-auto">
                    <Image
