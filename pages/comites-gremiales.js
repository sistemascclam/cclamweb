            ...
            <div className="lg:w-8/12 py-1">
                <CardSectorista className="ml-5 p-1 flex" orientation="l">
                    ...
                    <div className="my-auto">
                        <p className="font-semibold">{sectorista.name}</p>
                        <a href={`https://wa.me/51${sectorista.telf}`} target="_blank" className="block text-sm">+51{sectorista.telf}</a>
                        <a href={`mailto:${sectorista.correo}`} target="_blank" className="block text-sm">{sectorista.correo}</a>
                    </div>
                </CardSectorista>
            </div>
        </div>
